...
function btnTinhThue() {
  ...
  // Xử lí:
  var thue = tinhThue(tongThuNhapNam, soNguoiPhuThuoc);

  // Đầu ra:
  var ketQua = "";
  ketQua += "Họ tên: " + hoTen + "<br>";
  ketQua += "Thuế thu nhập cá nhân : " + thue;
  document.getElementById('showTinhThue').innerHTML = ketQua;
}
